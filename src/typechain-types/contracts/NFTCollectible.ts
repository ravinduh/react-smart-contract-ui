...
export interface NFTCollectibleInterface extends utils.Interface {
  functions: {
    ...
    "mintNFTs(uint256,string,uint256)": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "ownerOf(uint256)": FunctionFragment;
    "receiptUsed(address,string)": FunctionFragment;
  ...
  events: {
    ...
    "MintNFT(address,string)": EventFragment;
...
export type MintNFTEvent = TypedEvent<[string, string], MintNFTEventObject>;
